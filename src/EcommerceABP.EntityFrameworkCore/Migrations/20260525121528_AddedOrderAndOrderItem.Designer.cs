...
{
    [DbContext(typeof(EcommerceABPDbContext))]
    [Migration("20260525121528_AddedOrderAndOrderItem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceABP.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EcommerceABP.Orders.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcommerceABP.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcommerceABP.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcommerceABP.Categories.Category", b =>
                {
                    b.HasOne("EcommerceABP.Categories.Category", "ParentCategory")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("EcommerceABP.Orders.OrderItem", b =>
                {
                    b.HasOne("EcommerceABP.Orders.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EcommerceABP.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceABP.Products.Product", b =>
                {
                    b.HasOne("EcommerceABP.Categories.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EcommerceABP.Categories.Category", null)
                        .WithMany("Products")
