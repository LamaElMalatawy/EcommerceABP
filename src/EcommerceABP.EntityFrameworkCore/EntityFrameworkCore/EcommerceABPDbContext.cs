...
public class EcommerceABPDbContext :
    AbpDbContext<EcommerceABPDbContext>,
    ...
    IIdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(EcommerceABPConsts.DbTablePrefix + "YourEntities", EcommerceABPConsts.DbSchema);
